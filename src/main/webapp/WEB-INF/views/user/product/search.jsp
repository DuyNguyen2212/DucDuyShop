...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Kết quả tìm kiếm</h1>
                    ...
                    <c:if test="${ totaldata > 12 }">
                        ...
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center mb-3">
                            <li class="page-item">
                              <a class="page-link" href="<c:url value="/search${ searchstring }/p1" />" aria-label="Previous">
                            ...
                            <c:forEach var="item" begin="1" end="${ paginationinfo.total }" varStatus="itemS">
		                    	<c:if test="${ itemS.index == paginationinfo.current }">
		                    		<li class="page-item active">
		                    			<a class="page-link" href="<c:url value="/search${ searchstring }/p${ itemS.index }" />">${ itemS.index }</a>
		                    		</li>
		                    	</c:if>
		                    	<c:if test="${ itemS.index != paginationinfo.current }">
		                    		<li class="page-item">
                              ...
                              <a class="page-link" href="<c:url value="/search${ searchstring }/p${ lastPage }" />" aria-label="Next">
