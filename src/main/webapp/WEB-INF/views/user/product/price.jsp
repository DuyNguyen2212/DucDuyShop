                    ...
                    <c:if test="${ totaldata > 12 }">
                        ...
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center mb-3">
                            <li class="page-item">
                              <a class="page-link" href="<c:url value="/price${ price.id }_${ price.from }_${ price.to }/p1" />" aria-label="Previous">
                            ...
                            <c:forEach var="item" begin="1" end="${ paginationinfo.total }" varStatus="itemS">
		                    	<c:if test="${ itemS.index == paginationinfo.current }">
		                    		<li class="page-item active">
		                    			<a class="page-link" href="<c:url value="/price${ price.id }_${ price.from }_${ price.to }/p${ itemS.index }" />">${ itemS.index }</a>
		                    		</li>
		                    	</c:if>
		                    	<c:if test="${ itemS.index != paginationinfo.current }">
		                    		<li class="page-item">
                              ...
                              <a class="page-link" href="<c:url value="/price${ price.id }_${ price.from }_${ price.to }/p${ lastPage }" />" aria-label="Next">
