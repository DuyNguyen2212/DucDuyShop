          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <form:form action="editcompany${ editcompany.id }" method="post" modelAttribute="editcompany" enctype="multipart/form-data" id="edit-form" class="form-horizontal">
                  ...
                  <div class="form-group">
              		<label for="imageupload" class="col-sm-2 control-label">Logo</label>
              		<div class="col-sm-10">
              			<div><img id="image" style="max-width: 20%; height: auto" src="<c:url value="/assets/img/company/${ editcompany.image }" />" alt="Image" /></div>
