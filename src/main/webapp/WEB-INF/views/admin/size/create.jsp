          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <form:form action="createsize" method="post" modelAttribute="newsize" id="create-form" class="form-horizontal">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Size</label>
                    <div class="col-sm-10">
                      <form:input path="size" type="text" class="form-control" id="size" placeholder="Size" />
                    </div>
