          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <form:form action="deletecategory${ deletecategory.id }" method="post" modelAttribute="deletecategory" id="edit-form" class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-1">
                    	<a class="btn btn-danger" href="<c:url value="/admin/category" />">Huỷ</a>
                    </div>
                    <div class="col-sm-1">    
