          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div style="display: flex; align-items: center; padding: 16px">
              	<div>Thêm mới</div>
              	<a style="margin-left: 10px" class="btn btn-primary" href="<c:url value="/admin/createcategory" />"><i class="icon_plus_alt2"></i></a>
              </div>
                ...
                <tbody>
                  ...
                  <c:forEach var="item" items="${ pagination }">
                  	<tr>
	                      ...
	                      <div class="btn-group">
	                        <a class="btn btn-success" href="<c:url value="/admin/editcategory${ item.id }" />"><i class="icon_pencil"></i></a>
	                        <a class="btn btn-danger" href="<c:url value="/admin/deletecategory${ item.id }" />"><i class="icon_close_alt2"></i></a>
	                      </div>
	                    </td>
